...
<script lang="ts">
	...
	const icons = {
		...
		activeProjects: `<svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' stroke-width='1.5' stroke='currentColor' class='w-5 h-5'><path stroke-linecap='round' stroke-linejoin='round' d='M20.25 14.15v4.05a2.25 2.25 0 01-2.25 2.25H5.625a2.25 2.25 0 01-2.25-2.25v-13.5a2.25 2.25 0 012.25-2.25h4.05m-4.05 0a2.25 2.25 0 012.25-2.25h3.75a2.25 2.25 0 012.25 2.25m4.5 0v4.05a2.25 2.25 0 002.25 2.25h4.05a2.25 2.25 0 002.25-2.25V6.75a2.25 2.25 0 00-2.25-2.25h-4.05a2.25 2.25 0 00-2.25 2.25v4.05m0 0a2.25 2.25 0 00-2.25 2.25h-4.05a2.25 2.25 0 00-2.25-2.25V6.75a2.25 2.25 0 002.25-2.25h3.75a2.25 2.25 0 002.25 2.25z' /></svg>`,
